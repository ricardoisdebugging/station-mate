...
namespace StationMate.DataMgmt.MetaObject
{
    ...
    public abstract class ObjectInstance
    {
        ...
        public ObjectInstance(string instanceName, ObjectSchemaBase objectConf)
        {
        ...
        /// 元数据对象配置
        /// </summary>
        public ObjectSchemaBase ObjectConf { get; set; }
        /// <summary>
        /// 元数据对象实例名
        /// 可按任意格式设置，不可修改
        /// </summary>
        ...
        /// 元数据属性实例列表
        /// </summary>
        public List<PropertyInstanceBase> Properties { get; private set; }
        /// <summary>
        /// 添加元数据属性实例列表
        /// </summary>
        /// <param name="properties">元数据属性实例列表</param>
        public void AddProperties(List<PropertyInstanceBase> properties)
        {
        ...
        public void AddProperty(PropertyInstanceBase property)
        {
            if (property is null)
